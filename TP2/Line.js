class Line extends CGFobject {
    constructor(scene, texture1, texture2, y) {
        super(scene);
        this.y = y;
        this.piece0 = new Piece(scene, texture1);
        this.piece1 = new Piece(scene, texture2);
        this.piece2 = new Piece(scene, texture1);
        this.piece3 = new Piece(scene, texture2);
        this.piece4 = new Piece(scene, texture1);
        this.piece5 = new Piece(scene, texture2);
    }
    display() {
